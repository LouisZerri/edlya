...
@section('title', 'Accès interdit — Edlya')

@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center">
        <div class="text-6xl font-bold text-red-500 mb-2">403</div>
        <h1 class="text-xl font-semibold text-slate-800 mb-2">Accès interdit</h1>
        <p class="text-slate-500 mb-6">Vous n'avez pas les droits nécessaires pour accéder à cette page.</p>
