...
@section('title', 'Erreur serveur — Edlya')

@section('content')
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-8 text-center">
        <div class="text-6xl font-bold text-red-500 mb-2">500</div>
        <h1 class="text-xl font-semibold text-slate-800 mb-2">Erreur serveur</h1>
        <p class="text-slate-500 mb-6">Une erreur inattendue s'est produite. Notre équipe en a été informée.</p>
