...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6"
         ...
         data-store-url="{{ route('etats-des-lieux.import.store') }}"
        ...
        <!-- Étape 1: Upload -->
        <div id="step-upload">
            <div class="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center hover:border-indigo-400 transition-colors" id="dropzone">
                ...
                <label class="mt-4 inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-lg cursor-pointer hover:bg-indigo-700">
                    <span>Parcourir</span>
            ...
            <button type="button" id="btn-analyze" class="hidden mt-6 w-full py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer">
                Analyser le PDF
            </button>
        </div>
        ...
        <div id="step-preview" class="hidden">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div id="logement-existant" class="hidden mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <label class="mt-2 flex items-center gap-2">
                        <input type="checkbox" id="use-existing-logement" checked class="rounded border-gray-300 text-indigo-600">
            ...
            <div class="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input type="tel" id="preview-locataire-telephone" class="w-full border-gray-300 rounded-lg">
                    </div>
                </div>
            </div>
           ...
           <!-- Pièces -->
            <div class="mb-6">
                <h3 class="font-semibold text-gray-900 mb-3">Pièces et éléments (<span id="pieces-count">0</span>)</h3>
            ...
            <div class="flex gap-4 mt-8">
                <button type="button" id="btn-back" class="flex-1 py-3 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-50 cursor-pointer">
                    Recommencer
                </button>
                <button type="button" id="btn-import" class="flex-1 py-3 bg-indigo-600 text-white rounded-lg font-semibold hover:bg-indigo-700 cursor-pointer">
        ...
        <div id="step-error" class="hidden text-center py-12">
            ...
            <button type="button" id="btn-retry" class="mt-6 px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 cursor-pointer">
                Réessayer
            </button>
        </div>
    </div>
